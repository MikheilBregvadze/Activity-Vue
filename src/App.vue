    ...
    <section class="container">
      <div class="columns">
        <div class="column is-3">
          <activity-create :categories="categories" @activityCreated="addActivity" />
        </div>
          ...
          <div class="box content" :class="{fetching: isFetching, 'has-error': error}">
            ...
            <div v-if="!isFetching && !error">
              <div class="activity-length">
                Currently {{ ativityLength }} activity
              </div>
...
export default {
  ...
  data() {
    return {
      creator: 'Mikheil Bregvadze',
      appName: 'Activity planner',
      watchedAppName: 'Activity app by Gela Gnolidze',
      isFetching: false,
      error: null,
      user: {},
      activities: {},
  ...
  computed: {
    ...
    activityMotivation() {
      if(this.ativityLength && this.ativityLength < 5) {
        return 'Nice to see some activities (:'
      } else if(this.ativityLength >= 5) {
